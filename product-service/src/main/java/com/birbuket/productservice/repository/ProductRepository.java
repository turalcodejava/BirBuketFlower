...
public interface ProductRepository extends JpaRepository<Product, Long>, JpaSpecificationExecutor<Product> {
    ...
    Page<Product> findByIsSingle(boolean isSingle, Pageable pageable);

    Page<Product> findByProductCategory_IdAndIsSingle(Long categoryId, boolean isSingle, Pageable pageable);
}
